...
<head>
  ...
  <title>
    <?php
    if (isset($_GET['quanly']) && isset($_GET['hienthi']))
    {
      ...
      <div class="sidebar-wrapper scrollbar scrollbar-inner">
        <div class="sidebar-content">
          <ul class="nav nav-secondary">
            ...
            <li class="nav-item">
              <a href="index.php?quanly=loaihang&hienthi=danhsach">
            ...
            <li class="nav-item">
              <a href="index.php?quanly=thuonghieu&hienthi=danhsach">
            ...
            <li class="nav-item">
              <a href="index.php?quanly=mathang&hienthi=danhsach">
        ...
        <div class="container-fluid">
          <nav class="navbar navbar-header-left navbar-expand-lg navbar-form nav-search p-0 d-none d-lg-flex">
            <div class="input-group" style="display: none;">
              ...
              <input type="text" placeholder="Search ..." class="form-control" style="display: none;" />
            </div>
          </nav>

          <ul class="navbar-nav topbar-nav ms-md-auto align-items-center">
            <li class="nav-item topbar-icon dropdown hidden-caret d-flex d-lg-none">
              <a class="nav-link dropdown-toggle" data-bs-toggle="dropdown" href="#" role="button" aria-expanded="false" aria-haspopup="true" style="display: none;">
            ...
            <li class="nav-item topbar-icon dropdown hidden-caret" style="display: none;">
          ...
          <li class="nav-item topbar-user dropdown hidden-caret">
            ...
            <ul class="dropdown-menu dropdown-user animated fadeIn" style="display: none;">
              <div class="dropdown-user-scroll scrollbar-outer">
                <li>
                  <div class="user-box">
                    ...
                    <div class="u-text">
                      <h4>Admin</h4>
                      <p class="text-muted">admin@shop.com</p>
                      <a href="profile.html" class="btn btn-xs btn-secondary btn-sm">Xem thông tin</a>
                    </div>
                  </div>
                </li>
                <li>
...
if (isset($_GET['quanly']) && isset($_GET['hienthi']))
{
  if ($_GET['quanly'] == 'loaihang') {
    ...
    if ($_GET['hienthi'] == 'them') {
      include('hienthi/mathang/them-mathang.php');
    } else if ($_GET['hienthi'] == 'sua') {
      include('hienthi/mathang/sua-mathang.php');
    } else if ($_GET['hienthi'] == 'xoa') {
  ...
  include('hienthi/bangtonghop.php');
}
?>
<!-- End Pages -->
